    ...
    return (
        <div className="flex flex-col font-medium w-full">
            <div className="flex">
                ...
                <div >
                    <IndivGrayTabs classTab = {toggleTab === 1 ? " focus:bg-gray-650 focus:outline-none rounded-md px-2 text-white mx-2 " : "text-gray-450 mx-2 " } onClicky={() => handleToggle(1)} btnText={'Online'}/>
...
const FriendsText = () => {
    return (
        <div className="flex border-r px-2 py-0">
            <span>
...
const AddFriendTab = () => {
    return (
        <button className="bg-green-500 py-1  px-2 text-sm font-semibold text-white rounded-md">
            Add Friend
        </button>
    )
}
