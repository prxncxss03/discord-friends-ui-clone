...
const FriendsText = () => {
    return (
        <div className="flex border-r border-r-gray-400 justify-center items-center px-4">
            <span>
...
const AddFriendTab = () => {
    return (
        <button className="bg-green-500 py-1 flex items-center px-2 text-sm font-semibold text-white rounded-md">
            Add Friend
        </button>
    )
}
