            ...
            <div className="absolute top-0 w-full ">
                <div className="mx-1 flex bg-gray-900 p-1 justify-center items-center rounded-sm w-full">
                    ...
                    <span className="">
                        ...
                        <svg onClick={setSearchTerm("")} className={searchTerm.length !== 0 ? "flex ease-in-out 800ms" : "hidden ease-in-out 800ms "} aria-label="Clear" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24"><path fill="#B9BBBE" d="M18.4 4L12 10.4L5.6 4L4 5.6L10.4 12L4 18.4L5.6 20L12 13.6L18.4 20L20 18.4L13.6 12L20 5.6L18.4 4Z"></path></svg>
                    </span>
                </div>
