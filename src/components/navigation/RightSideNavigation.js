   ...
   return (
       <div className="flex flex-col ">
            ...
            <div className="flex justify-end py-3 px-2  shadow-defi">
                ...
                <div className="bg-gray-600 w-1px py-3 mx-2"></div>
                ...
                <Tooltipp tooltipTitle={'Help'} tooltipPlacement={'bottom'} tooltipChild={
                    <span className="right-icon sm:hidden lg:block">
...
const ActiveNows = () => {
    return (
        <div className="text-white w-350px border-l border-l-gray-600 h-full py-5 px-4 sm:hidden xl:block">
