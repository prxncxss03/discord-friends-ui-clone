...
export const MainSidebar = () => {
   return (
       <div className=" bg-gray-800 flex flex-col w-60 ml-16 h-screen">
           <MainSearchBar />
...
const MainSearchBar = () => {
    return (
        <div className="w-full h-12 shadow-defi border-b-1 border-b-gray-900 shadow-def ">
...
const MainSelectWrapper = ({mainSelect1,mainSelect2}) => {
    return (
        <div className="m-2 flex flex-col ">
            ...
            <div className="flex justify-between text-gray-400 bg-gray-700 rounded-md">
                {mainSelect2}
