...
export const MainSidebar = () => {
   ...
   return (
       <div className={sidebarStatus === true ?  'bg-gray-800 pl-2 flex flex-col sm:w-sidebar-width w-1400 ml-16 h-screen justify-between transition-all duration-200 ease-linear' : 'w-1 mr-16 flex flex-col transition-all duration-200 ease-linear h-screen justify-between'}>
           <div>
               <MainSearchBar />
